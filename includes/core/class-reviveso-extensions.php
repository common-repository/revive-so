	...
	public function extensions() {
		...
		<div class="reviveso-extensions-header py-3">
			<div class="reviveso-extensions__action_buttons">
				<a href="#" id="reviveso-reload-extensions" class="rounded-full bg-indigo-50 px-2.5 py-1.5 text-sm font-semibold text-indigo-600 shadow-sm hover:bg-indigo-100" data-nonce="<?php
